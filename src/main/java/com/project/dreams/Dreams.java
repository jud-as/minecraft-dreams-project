...
public class Dreams {
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "dreams" namespace
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(MOD_ID);
    // Create a Deferred Register to hold Items which will all be registered under the "dreams" namespace
    ...
    // Creates a creative tab with the id "dreams:example_tab" for the example item, that is placed after the combat tab
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.dreams")) //The language key for the title of your CreativeModeTab
    ...
    public Dreams(IEventBus modEventBus, ModContainer modContainer) {
        ...
        com.project.dreams.item.domain.model.OilLampDataComponents.register(modEventBus);
    ...
    private void addCreative(BuildCreativeModeTabContentsEvent event) {
        ...
        if (event.getTabKey() == CreativeModeTabs.TOOLS_AND_UTILITIES) {
            event.accept(ModItems.OIL_LAMP.get());
